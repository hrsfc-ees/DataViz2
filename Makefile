...
DataVisualisation-Linux-Debug:
	 $(PROJECTBUILD) DataVisualisation Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

DataVisualisation-Linux-DebugGame:
	 $(PROJECTBUILD) DataVisualisation Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

DataVisualisation-Linux-Shipping:
	 $(PROJECTBUILD) DataVisualisation Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

DataVisualisation-Linux-Test:
	 $(PROJECTBUILD) DataVisualisation Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

DataVisualisation:
	 $(PROJECTBUILD) DataVisualisation Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)

DataVisualisationEditor-Linux-Debug:
	 $(PROJECTBUILD) DataVisualisationEditor Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

DataVisualisationEditor-Linux-DebugGame:
	 $(PROJECTBUILD) DataVisualisationEditor Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

DataVisualisationEditor-Linux-Shipping:
	 $(PROJECTBUILD) DataVisualisationEditor Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

DataVisualisationEditor-Linux-Test:
	 $(PROJECTBUILD) DataVisualisationEditor Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

DataVisualisationEditor:
	 $(PROJECTBUILD) DataVisualisationEditor Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)
