...
unrealRootPath=/home/arnavk/Unreal/UnrealEngine
DataVisualisationRootPath=/home/arnavk/Documents/Unreal Projects/DataVisualisation

gameProjectFile=/home/arnavk/Documents/Unreal Projects/DataVisualisation/DataVisualisation.uproject
...
include(DataVisualisationSource.pri)
include(DataVisualisationHeader.pri)
include(DataVisualisationConfig.pri)
include(DataVisualisationIncludes.pri)
include(DataVisualisationDefines.pri)

DataVisualisation-Linux-Debug.commands = $$build DataVisualisation Linux Debug  -project="\"$$gameProjectFile\"" $$args
DataVisualisation-Linux-DebugGame.commands = $$build DataVisualisation Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
DataVisualisation-Linux-Shipping.commands = $$build DataVisualisation Linux Shipping  -project="\"$$gameProjectFile\"" $$args
DataVisualisation-Linux-Test.commands = $$build DataVisualisation Linux Test  -project="\"$$gameProjectFile\"" $$args
DataVisualisation.commands = $$build DataVisualisation Linux Development  -project="\"$$gameProjectFile\"" $$args

DataVisualisationEditor-Linux-Debug.commands = $$build DataVisualisationEditor Linux Debug  -project="\"$$gameProjectFile\"" $$args
DataVisualisationEditor-Linux-DebugGame.commands = $$build DataVisualisationEditor Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
DataVisualisationEditor-Linux-Shipping.commands = $$build DataVisualisationEditor Linux Shipping  -project="\"$$gameProjectFile\"" $$args
DataVisualisationEditor-Linux-Test.commands = $$build DataVisualisationEditor Linux Test  -project="\"$$gameProjectFile\"" $$args
DataVisualisationEditor.commands = $$build DataVisualisationEditor Linux Development  -project="\"$$gameProjectFile\"" $$args
...
QMAKE_EXTRA_TARGETS += \ 
	DataVisualisation-Linux-Debug \
	DataVisualisation-Linux-DebugGame \
	DataVisualisation-Linux-Shipping \
	DataVisualisation-Linux-Test \
	DataVisualisation \
	DataVisualisationEditor-Linux-Debug \
	DataVisualisationEditor-Linux-DebugGame \
	DataVisualisationEditor-Linux-Shipping \
	DataVisualisationEditor-Linux-Test \
	DataVisualisationEditor \
